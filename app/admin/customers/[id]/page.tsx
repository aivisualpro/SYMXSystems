    ...
    if (customer) {
      setLeftContent(
        <div className="flex items-center gap-3">
          <h1 className="text-xl font-black tracking-tight text-foreground uppercase">{customer.name}</h1>
      ...
      <div className="grid grid-cols-3 gap-6 p-6 h-full overflow-hidden">
        ...
        <div className="bg-muted/10 rounded-[2.5rem] border border-dashed border-muted/50 flex items-center justify-center relative overflow-hidden group">
          ...
          <div className="text-center space-y-2 relative z-10">
             ...
             <p className="font-black uppercase text-[10px] tracking-[0.3em] text-muted-foreground opacity-50">Order History</p>
        ...
        <div className="bg-muted/10 rounded-[2.5rem] border border-dashed border-muted/50 flex items-center justify-center relative overflow-hidden group">
          ...
          <div className="text-center space-y-2 relative z-10">
            ...
            <p className="font-black uppercase text-[10px] tracking-[0.3em] text-muted-foreground opacity-50">Customer Insights</p>
            <p className="text-xs text-muted-foreground">Coming Soon</p>
          </div>
        </div>
      </div>
