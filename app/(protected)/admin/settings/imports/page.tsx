...
const importTypes = [
  ...
  {
    id: "writeups",
    name: "Write-Ups (Historical)",
    description: "Import historical employee write-up/coaching records from CSV so they count toward the escalation ladder. Requires Transporter ID and Category (matched against the Write-Ups category list, or auto-created). Records are marked historical and default to a signed status.",
    icon: ClipboardPen,
    ...
    fields: [
      "Transporter ID", "Employee Name", "Category", "Incident Date",
      "Warning Level", "Description", "Plan for Improvement",
      "Consequences", "Manager Name", "Status",
    ],
  },
];
