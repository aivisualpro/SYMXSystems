...
const importTypes = [
  ...
  {
    id: "coaching-writeups",
    name: "Coaching WriteUps",
    description: "Import coaching and writeup records from CSV. Upserts on Transporter ID + Incident Date. file1–file5 are merged into a files array.",
    icon: ClipboardPen,
    ...
    fields: [
      "transporterId", "durationOfIncident", "incidentDate", "incidentWeek",
      "type", "metric", "correctiveActionNumber", "metricNoticeNumber",
      "correctiveAction", "correctiveActionDate", "supervisor", "metricValue",
      "seatbeltOffRate", "speedingEventRate", "distractionsRate",
      "signSignalViolationsRate", "followingDistanceRate",
      "DAMishandledPackage", "DAWasUnprofessional",
      "DADidNotFollowMyDeliveryInstructions", "deliveredToWrongAddress",
      "neverReceivedDelivery", "receivedWrongItem",
      "improvedByDate", "suggestion", "totalNegativeFeedbacks",
      "priorDiscussionOrWarningsOnThisSubject", "goal",
      "file1", "file2", "file3", "file4", "file5",
      "unSignedPdf", "signedPdf", "createdBy", "createdAt",
    ],
  },
];
